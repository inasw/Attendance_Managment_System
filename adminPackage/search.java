...
public class search extends JFrame{
    void searchStudent(){
        ...
        JLabel label = new JLabel("Please enter the Student ID You Want to Search", SwingConstants.CENTER);
        label.setFont(font);
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            try {
                ...
                // Display the teacher's information in a pop-up message
                if (rs.next()) {
    ...
    void searchTeacher(){
       ...
       // Create a label and add it to the top center of the window
       JLabel label = new JLabel("Please enter the Teacher ID You Want to Search", SwingConstants.CENTER);
       label.setFont(font);
       add(label, BorderLayout.NORTH);
       //setting
       JPanel textFieldPanel = new JPanel(new GridLayout(1, 2));
